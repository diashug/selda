...
@export_group("AttachementPosition")
@export var left_attachement_position: Vector2
@export var right_attachement_position: Vector2
@export var front_attachement_position: Vector2
@export var back_attachement_position: Vector2
@export_group("")
